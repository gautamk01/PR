...
from quantize.block_ap_sensitivity import block_ap  # CHANGED: Use sensitivity version
...
def main():
    ...
    # ADDED: Sensitivity-based arguments
    ...
    parser.add_argument("--adaptive_epochs", action="store_true",
                        help="Enable adaptive epochs based on sensitivity (1.0x to 1.25x)")
